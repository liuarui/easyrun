...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('events'), require('child_process'), require('os'), require('tty')) :
  typeof define === 'function' && define.amd ? define(['events', 'child_process', 'os', 'tty'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.events, global.child_process, global.require$$0, global.require$$1));
}(this, (function (events, child_process, require$$0, require$$1) { 'use strict';
...
${section.body}` : section.body;
  ...
  */
  ...
  function outputDividingLine() {
      console.log(source.bgBlackBright('*********************************************'));
  }
  function execCommand(command, opts) {
      try {
          outputDividingLine();
          console.log(source.bold.green('run script...'));
          child_process.execSync(command, Object.assign({
              stdio: 'inherit'
          }, opts));
          console.log(source.bold.green('script done'));
      }
      catch (e) {
          console.log(source.bold.red('erun exec script exit'));
      }
  }
  ...
  async function execSingleScripts() {
      outputScripts();
  ...
  function outputScripts() {
      ...
      if (Object.keys(scripts).length === 0) {
          ...
          console.log(source.bold('🆒 Your project has the following script.'));
          outputDividingLine();
          console.log(scripts);
          outputDividingLine();
      }
